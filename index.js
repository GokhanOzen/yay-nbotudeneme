...
client.on('ready', async () => {
 ...
 client.user.setActivity(`c!oynat | botclub.net`, { type:'PLAYING' })
...
client.on("ready", () => console.log("Bot Aktif | Asreaper"));
    ...
    if (cmd === "yttogether") {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then(invite => {
                ...
                message.channel.send(`** Club Activities** 'i Başlatmak İçin Tıklayın! ${channel.name}: <https://discord.gg/${invite.code}>`);
            })
            .catch(e => {
                message.channel.send("** Club Activities ** başlatılamadı!");
            })
    }
